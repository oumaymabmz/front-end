          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h3 className="font-semibold">
                {language === 'en' ? 'Location' : language === 'fr' ? 'Emplacement' : 'Standort'}
              </h3>
              <p>
            ...
            <div className="bg-green-500 p-4 rounded-full">
              ...
              >
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth="2"
                  d="M3 8h18M3 8h18m-7 4h4l1 5H5l1-5h4m-5 5a2 2 0 01-2-2V4h6v4m0 0h8V4h6v12a2 2 0 01-2 2H5z"
                />
              </svg>
            </div>
            <div>
